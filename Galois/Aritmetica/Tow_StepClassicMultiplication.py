"""
----------------------------------------------------------------------------------------------------------
			Algoritmo Tow Step Classic Multiplication 
----------------------------------------------------------------------------------------------------------
...
def Algoritmo_towStepClassicMultiplication(A, B, M):
	R = reduccionMatrix_R(PolinomioBinario(M), M)
	D = poly_Multiplicacion(A, B, M) 
	return multiplicacion_Reduccion(R, D, M)
"""
def towStepClassicMultiplication(A, B, M, F):
